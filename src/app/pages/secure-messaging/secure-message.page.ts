...
export class SecureMessagePage implements OnDestroy {
    ...
    private initializePage() {
        ...
        this.sourceSubscription.add(this.secureMessagingProvider.getInitialData().subscribe(
    ...
    private sendMessage(message: MSecureMessageSendBody) {
        this.sourceSubscription.add(this.secureMessagingProvider.sendSecureMessage(message).subscribe(
            response => {
