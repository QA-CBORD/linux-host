export function generateQuestions(): any[] {
  return [
    ...
    { type: 'text', label: 'Secondary Email Address', name: 'text-1568315409856', subtype: 'text', attribute: 'Email' },
    { type: 'paragraph', subtype: 'blockquote', label: 'New Page', attribute: null },
    {
      ...
      values: [
        ...
        { label: 'Transgender Female', value: 'Transgender Female', selected: true },
        { label: 'Transgender Male', value: 'Transgender Male', selected: true },
        { label: 'Non-binary', value: 'Non-binary', selected: true },
      ],
      attribute: 'Gender',
    },
    {
      ...
      values: [
        { label: 'Fall 2020', value: 'Fall 2020', selected: true },
        { label: 'Spring 2021', value: 'Spring 2021', selected: true },
      ],
