...
export const MENU_LIST_ITEMS = new Map<string, string>([
  ...
  [SYSTEM_SETTINGS_CONFIG.enableMealDonations.name, 'Meal Donations'],
]);
...
export const MENU_LIST_ROUTES = new Map<string, string>([
  ...
  [SYSTEM_SETTINGS_CONFIG.enableMealDonations.name, LOCAL_ROUTING.mealDonations],
]);
...
export const MENU_LIST_ICONS = new Map<string, string>([
  ...
  [SYSTEM_SETTINGS_CONFIG.enableMealDonations.name, 'assets/icon/meal-filled-white.svg'],
]);
