...
export class RecentOrdersComponent implements OnInit {
  ...
  private initContentStrings() {
    ...
    this.contentStrings.labelRecentOrders =
      this.orderingService.getContentStringByName(ORDERING_CONTENT_STRINGS.labelRecentOrders);
    this.contentStrings.labelPendingOrders =
      this.orderingService.getContentStringByName(ORDERING_CONTENT_STRINGS.labelPendingOrders);
    this.contentStrings.labelCompletedOrders =
      this.orderingService.getContentStringByName(ORDERING_CONTENT_STRINGS.labelCompletedOrders);
    this.contentStrings.noRecentOrders =
      this.orderingService.getContentStringByName(ORDERING_CONTENT_STRINGS.noRecentOrders);
  }
}
