...
function launch_emulator () {
  ...
  options="@${emulator_name} -no-window -no-snapshot -screen no-touch -noaudio -memory 2048 -cache-size 1024 -no-boot-anim ${hw_accel_flag} -camera-front none -camera-back none"
